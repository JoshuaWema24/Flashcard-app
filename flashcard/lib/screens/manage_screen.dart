...
class _ManageScreenState extends State<ManageScreen> {
  ...
  Future<void> _delete(int index) async {
    ...
    // Safeguard: Context async gap check
  ...
  Widget _buildCardTile(Flashcard card, int index) {
    return Container(
      key: ValueKey(card.id ?? index), // Keeps the list items unique during UI redrawing
      ...
      body: _isLoading
          ...
          : _cards.isEmpty
              ...
              : ListView.separated(
                  ...
                  itemBuilder: (context, i) => _buildCardTile(_cards[i], i),
                ),
    );
  }
}